...
def print_all_gpu():
    ...
    for gpu in results:
        ...
        print(f"{gpu[1]:<15}{gpu[2]:<15}{gpu[3]:<6}{gpu[4]:<6}{gpu[5]:<6}") #For the fourth test, I reserved some blank spaces to ensure that the data in each column can be aligned.